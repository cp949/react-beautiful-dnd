...
[![Tested with jest](https://img.shields.io/badge/tested_with-jest-99424f.svg)](https://www.npmjs.com/package/@cp949/react-beautiful-dnd) [![Tested with cypress](https://img.shields.io/badge/tested%20with-cypress-brightgreen.svg?style=flat)](https://www.cypress.io/)
...
This codebase is designed to be **extremely performant** - it is part of its DNA. It is designed to perform the smallest amount of updates possible. You can have a read about performance work done for `@cp949/react-beautiful-dnd` here:
...
[![minzip](https://img.shields.io/bundlephobia/minzip/@cp949/react-beautiful-dnd.svg)](https://www.npmjs.com/package/@cp949/react-beautiful-dnd)
